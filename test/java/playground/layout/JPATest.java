...
public class JPATest {
	...
	public void addNonExistingElementToJPA() {
		...
		assertThat(elementService
				.getElementNoLogin(elementService.createKey(element.getId(), element.getCreatorPlayground())))
	...
	public void addExistingElementToJPA() {
		...
		assertThat(elementService.isElementInDatabase(element));
		assertThat(elementService
				.getElementNoLogin(userService.createKey(element.getId(), element.getCreatorPlayground())))
						.isEqualToIgnoringGivenFields(element, "creationDate");
	}
