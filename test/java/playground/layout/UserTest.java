...
//******************************************************************************************//
	...
	public void successfullyRegisterNewUser() {
		...
		NewUserForm postUserForm = new NewUserForm(User.EMAIL_FOR_TESTS, Constants.DEFAULT_USERNAME, Constants.AVATAR_FOR_TESTS, User.PLAYER_ROLE);
	...
	public void confirmUserEmailNotInDatabase() {
		...
		this.restTemplate.getForObject(this.url + Constants.Function_2, UserTO.class, Playground.PLAYGROUND_NAME, User.EMAIL_FOR_TESTS, User.DEFAULT_VERIFICATION_CODE);
	}
	...
	public void confirmUserWithCorrectCode() {
		...
		UserEntity u = new UserEntity(Constants.DEFAULT_USERNAME, User.EMAIL_FOR_TESTS, Constants.AVATAR_FOR_TESTS, User.MANAGER_ROLE, Playground.PLAYGROUND_NAME);
		this.userService.addUser(u);
		UserTO user = this.restTemplate.getForObject(this.url + Constants.Function_2, UserTO.class, Playground.PLAYGROUND_NAME, User.EMAIL_FOR_TESTS, u.getVerificationCode());
	...
	public void confirmUserNotInPlayground() {
		...
		UserEntity u = new UserEntity(Constants.DEFAULT_USERNAME, User.EMAIL_FOR_TESTS,Constants.AVATAR_FOR_TESTS, User.MANAGER_ROLE, Playground.PLAYGROUND_NAME);
		this.userService.addUser(u);
		this.restTemplate.getForObject(this.url + Constants.Function_2, UserTO.class, Playground.Other_Playground, User.EMAIL_FOR_TESTS, u.getVerificationCode());
	}
	...
	public void confirmUserWithIncorrectVerificationCode() {
		...
		this.userService.addUser(u);
		this.restTemplate.getForObject(this.url + Constants.Function_2, UserTO.class, Playground.PLAYGROUND_NAME, User.EMAIL_FOR_TESTS, code + "x");
	}
	...
	public void loginUserWithCorrectEmail() {
		...
		u.verifyUser();
		this.userService.addUser(u);
		UserTO user = this.restTemplate.getForObject(this.url + Constants.Function_3, UserTO.class, Playground.PLAYGROUND_NAME, User.EMAIL_FOR_TESTS);
		assertThat(user).isNotNull();
	}
	...
	public void loginUserEmailNotInDatabase() {
		...
		this.restTemplate.getForObject(this.url + Constants.Function_3, UserTO.class, Playground.PLAYGROUND_NAME, User.EMAIL_FOR_TESTS);
	}
	...
	public void loginUserNotInPlayground() {
		...
		UserEntity u = new UserEntity(Constants.DEFAULT_USERNAME, User.EMAIL_FOR_TESTS, Constants.AVATAR_FOR_TESTS, User.MANAGER_ROLE, Playground.Other_Playground);
		u.verifyUser();
		this.userService.addUser(u);
		this.restTemplate.getForObject(this.url + Constants.Function_3, UserTO.class, Playground.PLAYGROUND_NAME, User.EMAIL_FOR_TESTS);
	}
	...
	public void UserUpdateHisInfo() {
		...
		UserEntity managerUser = new UserEntity(Constants.DEFAULT_USERNAME, User.EMAIL_FOR_TESTS, Constants.AVATAR_FOR_TESTS, User.MANAGER_ROLE, Playground.PLAYGROUND_NAME);
	...
	public void UserUpdateAnotherUser() {
		...
		UserEntity otherUser = new UserEntity(Constants.DEFAULT_USERNAME, "other"+User.EMAIL_FOR_TESTS, Constants.AVATAR_FOR_TESTS, User.MANAGER_ROLE, Playground.PLAYGROUND_NAME);
