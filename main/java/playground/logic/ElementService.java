...
public interface ElementService {
	...
	ElementEntity[] getAllElementsTOInRadius(ElementTO element, double x, double y, double distance,int page, int size);
	...
	boolean checkEmailAndPlaygroundInElement(ElementEntity element, String creatorPlayground,
			String creatorEmail);
