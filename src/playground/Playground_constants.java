...
public interface Playground_constants {
	...
	final String PLAYER_ROLE = "PLAYER";
	final String UNDEFINED_ROLE = "NO_ROLE";
	final String GAME_RULES = "Our vision is to become a part of the official school program.\r\n"
	...
	final String PLAYGROUND_NAME = "playground.rolnik";
